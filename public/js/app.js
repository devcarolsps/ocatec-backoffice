! function (n) {
    ...
    t.prototype._reset = function () { 
        this.body.removeAttr("data-leftbar-theme") }, t.prototype.activateCondensedSidebar = function () { this.body.attr("data-leftbar-compact-mode", "condensed") }, t.prototype.deactivateCondensedSidebar = function () { this.body.removeAttr("data-leftbar-compact-mode") }, t.prototype.activateScrollableSidebar = function () { this.body.attr("data-leftbar-compact-mode", "scrollable") }, t.prototype.deactivateScrollableSidebar = function () { this.body.removeAttr("data-leftbar-compact-mode") }, t.prototype.activateDefaultTheme = function () { this._reset(), this.body.attr("data-leftbar-theme", "default") }, t.prototype.activateLightTheme = function () { this._reset(), this.body.attr("data-leftbar-theme", "light") }, t.prototype.activateDarkTheme = function () { this._reset(), this.body.attr("data-leftbar-theme", "dark") }, t.prototype.initMenu = function () {
        var t, e = this;
        this._reset(), 
        n(document).on("click", ".button-menu-mobile", function (t) { 
            t.preventDefault(), 
            e.body.toggleClass("sidebar-enable"), 
            ("full" === e.body.attr("data-layout") && "condensed" !== e.body.attr("data-leftbar-compact-mode")) || e.window.width() >= 768 ? e.body.toggleClass("hide-menu") : "condensed" === e.body.attr("data-leftbar-compact-mode") ? e.deactivateCondensedSidebar() : e.activateCondensedSidebar() ,

            e.window.width() < 768 ? e.body.removeClass("hide-menu") : ''
           }), 
           n(".side-nav").length && (t = n(".side-nav li .collapse"), n(".side-nav li [data-bs-toggle='collapse']").on("click", function (t) { return !1 }), t.on({
    ...
    function (a) {
        ...
        t.prototype._selectOptionsFromConfig = function () {
            ...
            var e = this;
            "true" == document.body.getAttribute("data-rightbar-onstart") && (localStorage.getItem("_HYPER_VISITED") || (localStorage.setItem("_HYPER_VISITED", !0), e.toggleRightSideBar())), a(document).on("click", ".end-bar-toggle", function () { e.toggleRightSideBar() }), a(document).on("click", "body", function (t) { 0 < a(t.target).closest(".end-bar-toggle, .end-bar").length || 0 < a(t.target).closest(".leftside-menu, .side-nav").length || a(t.target).hasClass("button-menu-mobile") || 0 < a(t.target).closest(".button-menu-mobile").length || (a("body").removeClass("end-bar-enabled"), a("body").removeClass("sidebar-enable")) }), a("input[type=checkbox][name=width]").change(function () {
                switch (a(this).val()) {
                    case "fluid":
                        a.App.activateFluid();
                        break;
    ...
    function (i) {
        ...
        t.prototype.initSelect2 = function () { i('[data-toggle="select2"]').select2() }, t.prototype.initMask = function () {
            ...
            var n = { startDate: moment().subtract(29, "days"), endDate: moment(), ranges: { Today: [moment(), moment()], Yesterday: [moment().subtract(1, "days"), moment().subtract(1, "days")], "Last 7 Days": [moment().subtract(6, "days"), moment()], "Last 30 Days": [moment().subtract(29, "days"), moment()], "This Month": [moment().startOf("month"), moment().endOf("month")], "Last Month": [moment().subtract(1, "month").startOf("month"), moment().subtract(1, "month").endOf("month")] } };
            i('[data-toggle="date-picker-range"]').each(function (t, e) {
                var a = i.extend({}, n, i(e).data()),
                    o = a.targetDisplay;
                i(e).daterangepicker(a, function (t, e) { o && i(o).html(t.format("MMMM D, YYYY") + " - " + e.format("MMMM D, YYYY")) })
            })
        ...
        }, t.prototype.init = function () { this.initSelect2(), this.initMask(), this.initDateRange(), this.initTimePicker(), this.initTouchspin(), this.initMaxlength() }, i.AdvanceFormApp = new t, i.AdvanceFormApp.Constructor = t
    }(window.jQuery),
    function (c) {
        "use strict";
